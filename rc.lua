...
--                                                                           --
-------------------------------------------------------------------------------
-- naughty.config.icon_dirs = { "/usr/share/icons/Tela/scalable/apps" }
...
-- client.connect_signal("focus", function(c)
-- 	c.border_color = beautiful.border_focus
-- 	if #c.screen.tiled_clients == 1 or awful.layout.getname() == "max" then
-- 		c.border_width = 0
...
-- 	if t.layout == awful.layout.suit.max or #t.screen.tiled_clients == 1 then
